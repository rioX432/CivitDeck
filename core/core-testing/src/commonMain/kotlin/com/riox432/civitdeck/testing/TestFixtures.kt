...
/**
 * Reusable domain-model builders for tests across all feature/core modules.
 *
 * Defaults are SFW and minimally populated; override only the fields the test
 * under inspection actually cares about.
 */
fun testModel(
    id: Long = 1L,
    ...
    modelVersions: List<ModelVersion> = listOf(testModelVersion(modelId = id)),
) = Model(
    id = id,
    name = name,
    description = null,
